 ...
 */
final class Version20260601123451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, professeur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, nom_purifie VARCHAR(50) NOT NULL, effectif INT NOT NULL, INDEX IDX_8F87BF96BAB22EE9 (professeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
